...
function LoadCalendarScript(callback){
	function LoadFullCalendarScript(){
		if(!$.fn.fullCalendar){
			$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/fullcalendar/fullcalendar.js', callback);
		}
		else {
	...
	if (!$.fn.moment){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/moment/moment.min.js', LoadFullCalendarScript);
	}
	else {
...
function LoadLeafletScript(callback){
	if (!$.fn.L){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/leaflet/leaflet.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadTimePickerScript(callback){
	if (!$.fn.timepicker){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/jquery-ui-timepicker-addon/jquery-ui-timepicker-addon.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadBootstrapValidatorScript(callback){
	if (!$.fn.bootstrapValidator){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/bootstrapvalidator/bootstrapValidator.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSelect2Script(callback){
	if (!$.fn.select2){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/select2/select2.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadDataTablesScripts(callback){
	function LoadDatatables(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/datatables/jquery.dataTables.js', function(){
			$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/datatables/ZeroClipboard.js', function(){
				$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/datatables/TableTools.js', function(){
					$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/datatables/dataTables.bootstrap.js', callback);
				});
			});
		});
	}
...
function LoadFineUploader(callback){
	if (!$.fn.fineuploader){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/fineuploader/jquery.fineuploader-5.0.5.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadXChartScript(callback){
	function LoadXChart(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/xcharts/xcharts.min.js', callback);
	}
	function LoadD3Script(){
		if (!$.fn.d3){
			$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/d3/d3.min.js', LoadXChart)
		}
		else {
			LoadXChart();
		}
...
function LoadFlotScripts(callback){
	function LoadFlotScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/flot/jquery.flot.js', LoadFlotResizeScript);
	}
	function LoadFlotResizeScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/flot/jquery.flot.resize.js', LoadFlotTimeScript);
	}
	function LoadFlotTimeScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/flot/jquery.flot.time.js', callback);
	}
	if (!$.fn.flot){
		LoadFlotScript();
	}
...
function LoadMorrisScripts(callback){
	function LoadMorrisScript(){
		if(!$.fn.Morris){
			$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/morris/morris.min.js', callback);
		}
		else {
			if (callback && typeof(callback) === "function") {
				callback();
	...
	if (!$.fn.raphael){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/raphael/raphael-min.js', LoadMorrisScript);
	}
	else {
		LoadMorrisScript();
	}
...
function LoadAmchartsScripts(callback){
	function LoadAmchartsScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/amcharts/amcharts.js', LoadFunnelScript);
	}
	function LoadFunnelScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/amcharts/funnel.js', LoadSerialScript);
	}
	function LoadSerialScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/amcharts/serial.js', LoadPieScript);
	}
	function LoadPieScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/amcharts/pie.js', callback);
	}
	if (!$.fn.AmCharts){
		LoadAmchartsScript();
	}
...
function LoadChartistScripts(callback){
	function LoadChartistScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/chartist/chartist.min.js', callback);
	}
	if (!$.fn.Chartist){
		LoadChartistScript();
	}
...
function LoadSpringyScripts(callback){
	function LoadSpringyScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/springy/springy.js', LoadSpringyUIScript);
	}
	function LoadSpringyUIScript(){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/springy/springyui.js', callback);
	}
	if (!$.fn.Springy){
		LoadSpringyScript();
	}
...
function LoadFancyboxScript(callback){
	if (!$.fn.fancybox){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/fancybox/jquery.fancybox.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadKnobScripts(callback){
	if(!$.fn.knob){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/jQuery-Knob/jquery.knob.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
...
function LoadSparkLineScript(callback){
	if(!$.fn.sparkline){
		$.getScript('/BLOG/src/GDdesign/AdminBundle/Resources/public/devoopsTemplate/plugins/sparkline/jquery.sparkline.min.js', callback);
	}
	else {
		if (callback && typeof(callback) === "function") {
			callback();
		...
		yaxes: [
			{ min: 0 },
			{
				...
				tickFormatter: function (value, axis) {
					return value.toFixed(axis.tickDecimals) + "Ã¢â€šÂ¬";
				}
			}
		],
		legend: { position: "sw" }
...
function FileUpload(){
	$('#bootstrapped-fine-uploader').fineUploader({
		...
		request: {
			endpoint: '/BLOG/www/app_dev.php/admin/save-image-ajax'
...
function LoadTestMap(){
	$.getJSON("http://www.telize.com/geoip?callback=?",
		function(json) {
			var osmap = new OpenLayers.Layer.OSM("OpenStreetMap");//Ã‘ï¿½Ã�Â¾Ã�Â·Ã�Â´Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ Ã‘ï¿½Ã�Â»Ã�Â¾Ã‘ï¿½ Ã�ÂºÃ�Â°Ã‘â‚¬Ã‘â€šÃ‘â€¹
			...
			var osmap1 = new OpenLayers.Layer.OSM("OpenStreetMap");//Ã‘ï¿½Ã�Â¾Ã�Â·Ã�Â´Ã�Â°Ã�Â½Ã�Â¸Ã�Âµ Ã‘ï¿½Ã�Â»Ã�Â¾Ã‘ï¿½ Ã�ÂºÃ�Â°Ã‘â‚¬Ã‘â€šÃ‘â€¹
		...
		fields: {
			username: {
				...
				validators: {
					...
					different: {
						field: 'bootstrapValidationUsername',
			...
			email: {
				validators: {
					...
					different: {
						field: 'bootstrapValidationEmail',
